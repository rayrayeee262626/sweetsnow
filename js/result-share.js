(function(root,factory){const api=factory();if(typeof module==="object"&&module.exports)module.exports=api;else root.ResultShare=api;})(typeof globalThis!=="undefined"?globalThis:this,function(){
  ...
  function postText(tenpais){return`牌尽 HAIJIN\n今回の記録：${tenpais}テンパイ\n136枚で、何回テンパイできるか。\n${GAME_URL}\n\n#牌尽 #HAIJIN`;}
  function openXPost(tenpais){const url=`https://twitter.com/intent/tweet?text=${encodeURIComponent(postText(tenpais))}`;window.open(url,"_blank","noopener,noreferrer");}
  ...
  async function generateCanvas(state,rules,tileAssets){
    ...
    ctx.textAlign="center";ctx.fillStyle="#e6bd62";ctx.font="700 30px 'Yu Gothic',sans-serif";ctx.fillText("一人用・136枚チャレンジ",540,70);
